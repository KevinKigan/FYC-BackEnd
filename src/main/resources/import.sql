...
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Honda','https://www.honda.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Jaguar','https://www.jaguar.es/index.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Bentley','https://www.bentleymotors.com/en.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Hyundai','https://www.hyundai.com/es.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Acura','https://www.acura.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Nissan','https://www.nissan.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Porsche','https://www.porsche.com/spain/');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('BMW','https://www.bmw.es/es/home.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Subaru','https://www.subaru.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Volvo','https://www.volvocars.com/es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Mercedes-Benz','https://www.mercedes-benz.es/passengercars.html?group=all&subgroup=see-all&view=BODYTYPE');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Ford','https://www.ford.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Lincoln','https://es.lincoln.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Lamborghini','https://www.lamborghini.com/es-en');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Scion','https://www.toyota.com/scion/');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Toyota','https://www.toyota.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Fiat','https://www.fiat.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Maserati','https://www.maserati.com/es/es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Infiniti','https://www.infiniti.com/europe/es-es.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Cadillac','https://www.cadillac.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Chevrolet','https://es.chevrolet.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Mitsubishi','https://www.mitsubishi-motors.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('GMC','https://www.gmc.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Buick','https://www.buick.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Dodge','https://es.dodge.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Jeep','https://www.jeep.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Land Rover','https://www.landrover.es/index.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Volkswagen','https://www.volkswagen.es/es.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Chrysler','https://es.chrysler.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Pagani','https://www.pagani.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Ram','https://es.ramtrucks.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('MINI','https://www.mini.es/es_ES/home.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Lexus','https://www.lexusauto.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Alfa Romeo','https://www.alfaromeo.es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Aston Martin','https://www.astonmartin.com/en/');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('McLaren Automotive','https://cars.mclaren.com/es-es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Roush Performance','https://www.roushperformance.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Rolls-Royce','https://www.rolls-roycemotorcars.com/en_GB/home.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('smart','https://www.smart.com/es/es');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Ferrari','https://www.ferrari.com/es-CR');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Genesis','https://www.genesis.com/worldwide/en/main.html');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Lotus','https://www.lotuscars.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Bugatti','https://www.bugatti.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Karma','https://www.karmaautomotive.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Koenigsegg','https://www.koenigsegg.com');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('RUF Automobile','https://ruf-automobile.de');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('STI','https://www.subaru.com/2019-S209');
INSERT INTO `marcas` (`marca_coche`,`url`) VALUES ('Polestar Automotive USA Inc.','https://www.polestar.com/us/');

INSERT INTO `carrocerias` (`carroceria`) VALUES ('Berlina');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Sedán');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Suv');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Cabrio');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Coupé');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Pickup');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Hatchback');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Monocasco');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Limusina');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Fúnebre');
INSERT INTO `carrocerias` (`carroceria`) VALUES ('Todoterreno');
...
INSERT INTO `modelos` (`marca_id`,`modelo`) VALUES (3,'A6 quattro');           /* 6  */
INSERT INTO `modelos` (`marca_id`,`modelo`) VALUES (4,'HR-V');                 /* 7  */
INSERT INTO `modelos` (`marca_id`,`modelo`) VALUES (5,'F-Type Coupe');         /* 8  */
INSERT INTO `modelos` (`marca_id`,`modelo`) VALUES (5,'F-Type Convertible');   /* 9  */
INSERT INTO `modelos` (`marca_id`,`modelo`) VALUES (5,'F-Type S Coupe');       /* 10 */
INSERT INTO `modelos` (`marca_id`,`modelo`) VALUES (5,'F-Type S Convertible'); /* 11 */
